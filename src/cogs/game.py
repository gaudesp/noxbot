...
class GameCog(commands.Cog):
  ...
  async def __followed_games(self):
  ...
  async def game_name_autocomplete(self, interaction: discord.Interaction, current: str):
  ...
  async def game_app_id_autocomplete(self, interaction: discord.Interaction, current: str):
    if not current:
      return []
  ...
  async def follow_game(self, interaction: discord.Interaction, game: str, channel: discord.TextChannel):
    app_id = game
  ...
  @app_commands.autocomplete(game=game_name_autocomplete)
  @app_commands.checks.has_permissions(administrator=True)
  async def unfollow_game(self, interaction: discord.Interaction, game: str):
    app_id = game
  ...
  @app_commands.autocomplete(game=game_name_autocomplete)
  @app_commands.checks.has_permissions(administrator=True)
  async def publish_news(self, interaction: discord.Interaction, game: str):
    app_id = game
